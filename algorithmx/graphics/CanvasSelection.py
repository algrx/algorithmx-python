...
def receive_handler(event: ReceiveEvent, listeners: SelectionListeners):
    ...
    if event["type"] == ReceiveEventType.Broadcast:
        ...
        trigger_listener(
            "{}-node-{}".format(
                "hoverin" if event_data["entered"] else "hoverout", event_data["id"]
            )
        )
...
class CanvasSelection(Selection):
    ...
    def nodes(self, ids: Iterable[Any]) -> NodeSelection:
        ...
        """
        node_context = create_child_context(
    ...
    def edges(
        self, edges: Iterable[Union[Tuple[Any, Any], Tuple[Any, Any, Any]]]
    ) -> None:
        """
        ...
        edge_context = create_child_context(
            parent=self._context,
            name="edges",
            ids=edge_ids,
            data=list(edges),
    ...
    def edgelengths(
        self: S, length_info: ElementArg[Union[str, Tuple[str, NumExpr]]]
    ) -> S:
        """
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, length_info, lambda d: {"edgelengths": d})
        )
        return self
    ...
    def pan(self: S, location: ElementArg[Tuple[NumExpr, NumExpr]]) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, location, lambda d: {"pan": d})
        )
        return self
    ...
    def zoom(self: S, zoom: ElementArg[NumExpr]) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, zoom, lambda d: {"zoom": d})
        )
        return self
    ...
    def panlimit(self: S, box: ElementArg[Tuple[NumExpr, NumExpr]]) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, box, lambda d: {"panlimit": d})
        )
        return self
    ...
    def zoomlimit(self: S, limit: ElementArg[Tuple[NumExpr, NumExpr]]) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, limit, lambda d: {"zoomlimit": d})
        )
        return self
    ...
    def zoomkey(self: S, required: ElementArg[bool]) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, required, lambda d: {"zoomkey": d})
        )
...
def canvas_selection(
    canvas: str, handler: EventHandler, canvas_class: CanvasSelection = CanvasSelection
) -> CanvasSelection:
