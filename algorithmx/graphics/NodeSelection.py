...
class NodeSelection(Selection):
    ...
    def shape(self: S, shape: ElementArg[str]) -> S:
        ...
        self._context.client.dispatch(
            attr_event(self._context, shape, lambda d: {"shape": d})
        )
        return self
    ...
    def fixed(self: S, fixed: ElementArg[bool]) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, fixed, lambda d: {"fixed": d})
        )
        return self
    ...
    def draggable(self: S, draggable: ElementArg[bool]) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, draggable, lambda d: {"draggable": d})
        )
        return self
    ...
    def click(self: S, on_click: ElementFn) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, True, lambda d: {"click": d})
        )
        for i, k in enumerate(self._context.ids):
            self._context.listeners["click-node-" + k] = lambda: call_element_fn(
                on_click, self._context.data[i], i
            )
        return self
    ...
    def hoverin(self: S, on_hoverin: ElementFn) -> S:
        ...
        """
        self._context.client.dispatch(
            attr_event(self._context, True, lambda d: {"hover": d})
        )
        for i, k in enumerate(self._context.ids):
            self._context.listeners["hoverin-node-" + k] = lambda: call_element_fn(
                on_hoverin, self._context.data[i], i
            )
        return self
    ...
    def hoverout(self: S, on_hoverout: ElementFn) -> S:
        ...
        for i, k in enumerate(self._context.ids):
            self._context.listeners["hoverout-node-" + k] = lambda: call_element_fn(
                on_hoverout, self._context.data[i], i
            )
        return self
